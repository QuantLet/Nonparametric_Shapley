...
bootstrap = function(j, N=1000, B=10000){
...
return(c(qs1, qs2, qs1_int, qs2_int)) #x1, x2
}
#quantile approach
...
shap_true = shapley_popul(j=1, c(0,-0.4), model_list = model_list_init) #-> definiere model_list_init global
